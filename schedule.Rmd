 ...
 * **In class**, we will work on:
    ...
    * Training and test sets -- why and how (Section 2.2 of ISLR)
        * Example 1: [pdf](materials/20190906_polynomial_train_test/20190906_train_test_Example_1.pdf)
        * Example 2: [pdf](materials/20190906_polynomial_train_test/20190906_train_test_Example_2.pdf)
        * Example 3: [pdf](materials/20190906_polynomial_train_test/20190906_train_test_Example_2_wrapup.pdf)
 * **After class**, please:
 ...
 * **In class**, we will work on:
    ...
    * Residual Sum of Squares (RSS), Total Sum of Squares (TSS) (Section 3.1 of ISLR)
    * Matrix notation view of least squares parameter estimates and fitted values (Not in ISLR but super important!!)
 * **After class**, please:
    * Continue reading Chapter 1, and Sections 2.1, 2.2.1, 2.2.2, 3.1, 3.2, and 3.3 of ISLR.
...
#### Wed, Sep 11
 * **In class**, we will work on:
    * Finish any remaining material from Monday
    * Lab on simple linear and polynomial regression, train/test splits, and sums of squares
 * **After class**, please:
    * Finish today's lab if you didn't have time to finish it in class.


#### Fri, Sep 13
 * **In class**, we will work on:
    * Mean Squared Error and the Bias/Variance trade-off (Sections 2.1.1 and 2.2.2 in ISLR)
 * **After class**, please:
")
```
