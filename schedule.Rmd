...
#### Mon, Sep 30
 * **In class**, we will work on:
    * KNN for Regression: [pdf](materials/20190930_KNN/20180920_KNN.pdf) [Rmd](materials/20190930_KNN/20180930_KNN.Rmd)
 * **After class**, please:
 ...
 * **In class**, we will work on:
    ...
    * KNN for classification: [pdf](materials/20191001_KNN_class/20191001_KNN_class.pdf) [Rmd](materials/20191001_KNN_class/20191001_KNN_class.Rmd)
 * **After class**, please:


#### Fri, Oct 04
 * **In class**, we will work on:
    * Lab on KNN for classification, cross-validation for classification
 * **After class**, please:
")
```
