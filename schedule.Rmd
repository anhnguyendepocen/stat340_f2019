 ...
 * **In class**, we will work on:
    ...
    * Brief reminder of commands for simple linear regression in R: [pdf](materials/20190904_intro/201900904_SLR_summary.pdf)
...
#### Fri, Sep 06
 * **In class**, we will work on:
    * Polynomial Regression (Section 3.3 of ISLR)
